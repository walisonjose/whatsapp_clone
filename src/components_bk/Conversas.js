...
import { conversaUsuarioFetch } from '../actions/AppActions';

class Conversas extends Component {

    componentWillMount() {
        this.props.conversaUsuarioFetch()
...
export default connect(mapStateToProps, { conversaUsuarioFetch })(Conversas)